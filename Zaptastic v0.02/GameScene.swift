            ...
            if currentWave.enemies.isEmpty {
                ...
                let enemy = EnemyNode(type: enemyTypes[enemyType], startPosition: CGPoint(x: enemyStartX, y: position), xOffset: enemyOffsetX * CGFloat(index * 3), moveStraight: true)
                   ...
                   for enemy in currentWave.enemies {
                    ...
                    let node = EnemyNode(type: enemyTypes[enemyType], startPosition: CGPoint(x: enemyStartX, y: positions[enemy.position]), xOffset: enemyOffsetX * CGFloat(enemy.xOffset), moveStraight: enemy.moveStraight)
               addChild(node)                }
             }
